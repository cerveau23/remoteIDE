...
export async function main(ns) {
    ...
    if (ns.args.length === 1) { // A target company has been passed to the script
        ...
        Array.from(documentFree.getElementsByClassName("css-1d6cey9")).find((element) => element.textContent === "Infiltrate Company").click();
    ...
    let targetCompany = documentFree.getElementsByClassName("css-1ro0679")[0].children[0].textContent;
 ...
 */
async function stringPressAPI(ns, string2press) {
...
/**
 * @return {boolean} The response to pinging the server
 */
